        ...
        <div className="dscroll flex-1 overflow-y-auto px-5 py-4">
          ...
          {tab==="profile" && (
            <>
              ...
              <InfoRow icon={FiUser}    label="House Name" value={member.houseName} color="#4EAEE5"/>
              ...
              <InfoRow icon={FiUsers}    label="Marital Status" value={member.maritalStatus}       color="#9B59B6"/>
              <InfoRow icon={FiUser}     label="Guardian"       value={member.guardianName}        color="#9B59B6"/>
              <InfoRow icon={FiPhone}    label="Guardian Phone" value={member.guardianPhone}       color="#9B59B6"/>
              ...
              {isMarried && (
                <>
                  ...
                  <InfoRow icon={FiUser}  label="Spouse Name"       value={member.spouseName}  color="#E91E8C"/>
              ...
              <InfoRow icon={FiHeart}    label="Blood Group" value={member.bloodGroup}           color="#E91E8C"/>
            </>
          )}
